...
import br.com.bertol.service.connections.RefreshConnections;
...
public class Router {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final var refreshConnections = new RefreshConnections(airportInclusion, writerRoutesToFile);
        final var handler = new RestServerHandler(routeSearcher, refreshConnections);
